...
fnirtSourceT1path = '/mnt/sourceFolder/subjectID/T1w/T2w_acpc_dc_restore.nii.gz'; %Provide the the non-skull-stripped T1w source image input into FNIRT during preprocessing to generate the warp
